    ...
    def _inner():
        ...
        out['content'] = [
            ...
            },
            {
                ...
                'slug': exclusive_products.product_range.slug,
                'content': pd(request, qs=exclusive_products.all_products(), limit=8, ),
                'view_all': exclusive_products.product_range.slug,
                'bg': '#f5f6fa',
                'color': '#555',
            },
            {
                ...
                'slug': furniture_for_your_home.product_range.slug,
            ...
            },
            {
                ...
                'slug': jambo_offer.product_range.slug,
                'content': pd(request, qs=jambo_offer.all_products(), limit=8, ),
                'view_all': jambo_offer.product_range.slug,
                'bg': '#f5f6fa',
                'color': '#333',
            },
            {
                ...
                'title': '',
                'slug': offer_banner_3.product_range.slug,
            ...
            },
            {
                ...
                'slug': picked_for_you.product_range.slug,
                'content': pd(request, qs=picked_for_you.all_products(), limit=8, ),
                'view_all': picked_for_you.product_range.slug,
                'bg': '#f5f6fa',
                'color': '#555',
            },
            {
                ...
                'slug': customer_favorites.product_range.slug,
                'content': pd(request, qs=customer_favorites.all_products(), limit=8, ),
                'view_all': customer_favorites.product_range.slug,
                'bg': '#f5f6fa',
                'color': '#555',
            },
            {
