    ...
    def _inner():
        ...
        out['content'] = [
            ...
            },
            {
                ...
                'content': pd(request, qs=exclusive_products.all_products().filter(Q(id__in=pids)|Q(parent_id__in=pids)), limit=8, ),
            ...
            },
            {
                ...
                'content': pd(request, qs=furniture_for_your_home.all_products().filter(Q(id__in=pids)|Q(parent_id__in=pids)), limit=8, ),
                'view_all': exclusive_products.slug,
                'bg': '#f5f6fa',
                'color': '#555',
            },
            ...
            },
            {
                ...
                'content': pd(request, qs=jambo_offer.all_products().filter(Q(id__in=pids)|Q(parent_id__in=pids)), limit=8, ),
            ...
            },
            {
                ...
                'content': pd(request, qs=picked_for_you.all_products().filter(Q(id__in=pids)|Q(parent_id__in=pids)), limit=8, ),
            ...
            },
            {
                ...
                'content': pd(request, qs=customer_favorites.all_products().filter(Q(id__in=pids)|Q(parent_id__in=pids)), limit=8, ),
