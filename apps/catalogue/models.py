...
class Product(AbstractProduct):
    ...
    wordpress_product_id = models.CharField(max_length=8, blank=True, null=True)
    wordpress_product_text = models.CharField(max_length=8, blank=True, null=True)
    ...
    def absolute_image_path(self):
        if self.primary_image():
            item = self.primary_image().original.url
            return item
